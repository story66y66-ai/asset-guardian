...
if selection == "訓練農場":
    ...
    if mode == "中文輸入挑戰":
        ...
        if st.button("確認答案") and user_in == word['trans']: st.success("✅ 答對！"); del st.session_state.quiz_word; st.rerun()
    else:
        ...
        if st.button("確認"):
            if ans.upper() == word['word'].upper(): st.success("✅ 答對！"); del st.session_state.quiz_word; st.rerun()
